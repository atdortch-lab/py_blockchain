...
def test_transaction():
    ...
    def test_transaction_update_exceeds_balance():
        ...
        with pytest.raises(Exception, mathc = 'Amount exceeds balance'):
            transaction.updat(sender_wallet, 'new_recipient', 9001)
    ...
    def test_transaction_update():
        ...
        next_amount = 75
        transaction.updat(sender_wallet, next_recipient, next_amount)
